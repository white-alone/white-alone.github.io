import{_ as a,o as n,c as o,aj as p}from"./chunks/framework.DNJ2HNkG.js";const q=JSON.parse('{"title":"shadowsocks安装与配置","description":"","frontmatter":{"title":"shadowsocks安装与配置","date":"2016-05-13T22:08:10.000Z","category":"Linux","tags":["软件"]},"headers":[],"relativePath":"posts/shadowsocks安装与配置.md","filePath":"posts/shadowsocks安装与配置.md","lastUpdated":1783047625000}'),t={name:"posts/shadowsocks安装与配置.md"};function e(l,s,c,u,i,d){return n(),o("div",null,[...s[0]||(s[0]=[p(`<p>我的VPS选的ub/debian系统</p><p>apt-get install python python-pip</p><p>pip install shadowsocks</p><p>vi /etc/shadowsocks.json</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>{</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>保存配置文件后启动</p><p>开始：ssserver -c /etc/shadowsocks.json -d start 结束：ssserver -c /etc/shadowsocks.json -d stop</p>`,7)])])}const _=a(t,[["render",e]]);export{q as __pageData,_ as default};
